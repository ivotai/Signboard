...
class BuildingListFra : BaseFra(), PageActOrFra<Building> {

    override var mAdapter: MyAdapter<Building, MyHolder>? = BuildingListAdapter()

    private var keyword = ""

    override fun loadPage(pageNo: Int): Observable<Page<Building>> {
        return AppTime.api.getBuilding(
            page = pageNo,
            pageSize = rows,
